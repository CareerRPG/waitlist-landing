      ...
      <AnimatePresence>
        {isScrolled && (
          <motion.nav
            ...
            className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-5xl px-6"
          >
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-slate-200/50 shadow-2xl shadow-slate-900/10">
              <div className="flex items-center justify-between px-8 py-3">
                ...
                >
                  ...
                  <span className="text-xl font-bold text-slate-900">Career<span className="bg-gradient-to-r from-emerald-500 to-blue-500 bg-clip-text text-transparent italic">RPG</span></span>
                </motion.div>
                ...
                <div className="hidden md:block">
                  <motion.button
                    onClick={() => scrollToSection('hero')}
                    className="bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-white font-semibold px-5 py-2 rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 text-sm flex items-center"
